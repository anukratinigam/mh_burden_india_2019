#!/bin/R
# ASAR_MH_EB_India_calc_working_group_Reanalysis2023.R
# By: Anukrati Nigam
...
calc_tmvyll_wg <- function( SD_20_24, SD_25_29, SD_30_34,
                            ...
                            k_20_24_lb, k_25_29_lb, k_30_34_lb,
                            k_35_39_lb, k_40_44_lb, k_45_49_lb,
                            k_50_54_lb, k_55_59_lb, k_60_64_lb,
                            k_20_24_ub, k_25_29_ub, k_30_34_ub,
                            k_35_39_ub, k_40_44_ub, k_45_49_ub,
                            k_50_54_ub, k_55_59_ub, k_60_64_ub
){
  tmvyll = 0
  tmvyll_lb = 0
  tmvyll_ub = 0
...
for( s in state_list){
  tmvyll_df_m_temp <- data.frame(state_name = character(), gender = character(), tmvyll = numeric(), 
                                 mvyll_20_24 = numeric(),mvyll_25_29 = numeric(),
                                 mvyll_30_34 = numeric(),mvyll_35_39 = numeric(),mvyll_40_44 = numeric(),mvyll_45_49 = numeric(),
                                 mvyll_50_54 = numeric(),mvyll_55_59 = numeric(),mvyll_60_64 = numeric(),mvyll_20_24_lb = numeric(),mvyll_25_29_lb = numeric(),
                                 mvyll_30_34_lb = numeric(),mvyll_35_39_lb = numeric(),mvyll_40_44_lb = numeric(),mvyll_45_49_lb = numeric(),
                                 mvyll_50_54_lb = numeric(),mvyll_55_59_lb = numeric(),mvyll_60_64_lb = numeric(),
                                 tmvyll_ub = numeric(), 
                                 mvyll_20_24_ub = numeric(),mvyll_25_29_ub = numeric(),
...
tmvyll_df_wg3_usd <- tmvyll_df_wg3
tmvyll_df_wg3_usd[,3:32] <- tmvyll_df_wg3_usd[,3:32]/82.572

write.csv(tmvyll_df_wg3, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r3_INR.csv")
write.csv(tmvyll_df_wg3_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r3_USD.csv")
...
tmvyll_df_wg5_usd <- tmvyll_df_wg5
tmvyll_df_wg5_usd[,3:32] <- tmvyll_df_wg5_usd[,3:32]/82.572

write.csv(tmvyll_df_wg5, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r5_INR.csv")
write.csv(tmvyll_df_wg5_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r5_USD.csv")
...
tmvyll_df_wg10_usd <- tmvyll_df_wg10
tmvyll_df_wg10_usd[,3:32] <- tmvyll_df_wg10_usd[,3:32]/82.572

write.csv(tmvyll_df_wg10, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r10_INR.csv")
write.csv(tmvyll_df_wg10_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r10_USD.csv")
