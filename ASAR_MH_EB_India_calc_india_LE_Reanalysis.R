...
write.csv(tmvyll_df_3_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Datasheets/UA_r3_kle_in_INR.csv")
write.csv(tmvyll_df_3_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Datasheets/UA_r3_kle_in_USD.csv")
...
write.csv(tmvyll_df_5_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Datasheets/UA_r5_kle_in_INR.csv")
write.csv(tmvyll_df_5_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Datasheets/UA_r5_kle_in_USD.csv")
...
write.csv(tmvyll_df_10_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Datasheets/UA_r10_kle_in_INR.csv")
write.csv(tmvyll_df_10_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Datasheets/UA_r10_kle_in_USD.csv")
