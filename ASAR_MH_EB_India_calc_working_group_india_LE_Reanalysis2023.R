#!/bin/R
# ASAR_MH_EB_India_calc_working_group_india_LE_Reanalysis2023.R
# By: Anukrati Nigam
...
for( s in state_list){
  tmvyll_df_m_temp <- data.frame(state_name = character(), gender = character(), tmvyll = numeric(), 
                                 ...
                                 mvyll_30_34 = numeric(),mvyll_35_39 = numeric(),mvyll_40_44 = numeric(),mvyll_45_49 = numeric(),
                                 mvyll_50_54 = numeric(),mvyll_55_59 = numeric(),mvyll_60_64 = numeric(),
                                 tmvyll_lb = numeric(), mvyll_20_24_lb = numeric(),mvyll_25_29_lb = numeric(),
                                 mvyll_30_34_lb = numeric(),mvyll_35_39_lb = numeric(),mvyll_40_44_lb = numeric(),mvyll_45_49_lb = numeric(),
                                 mvyll_50_54_lb = numeric(),mvyll_55_59_lb = numeric(),mvyll_60_64_lb = numeric(),tmvyll_ub = numeric(), 
                                 mvyll_20_24_ub = numeric(),mvyll_25_29_ub = numeric(),
                                 mvyll_30_34_ub = numeric(),mvyll_35_39_ub = numeric(),mvyll_40_44_ub = numeric(),mvyll_45_49_ub = numeric(),
                                 mvyll_50_54_ub = numeric(),mvyll_55_59_ub = numeric(),mvyll_60_64_ub = numeric())
  tmvyll_df_f_temp <- data.frame(state_name = character(), gender = character(), tmvyll = numeric(), 
                                 ...
                                 mvyll_30_34_lb = numeric(),mvyll_35_39_lb = numeric(),mvyll_40_44_lb = numeric(),mvyll_45_49_lb = numeric(),
                                 mvyll_50_54_lb = numeric(),mvyll_55_59_lb = numeric(),mvyll_60_64_lb = numeric(),
                                 tmvyll_ub = numeric(), mvyll_20_24_ub = numeric(),mvyll_25_29_ub = numeric(),
                                 mvyll_30_34_ub = numeric(),mvyll_35_39_ub = numeric(),mvyll_40_44_ub = numeric(),mvyll_45_49_ub = numeric(),
                                 mvyll_50_54_ub = numeric(),mvyll_55_59_ub = numeric(),mvyll_60_64_ub = numeric())
  r_val = 0.03
...
tmvyll_df_wg3_kle_in_usd[,3:32] <- tmvyll_df_wg3_kle_in_usd[,3:32]/82.572

write.csv(tmvyll_df_wg3_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r3_kle_in_INR.csv")
write.csv(tmvyll_df_wg3_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r3_kle_in_USD.csv")
...
tmvyll_df_wg5_kle_in_usd[,3:32] <- tmvyll_df_wg5_kle_in_usd[,3:32]/82.572

write.csv(tmvyll_df_wg5_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r5_kle_in_INR.csv")
write.csv(tmvyll_df_wg5_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r5_kle_in_USD.csv")
...
tmvyll_df_wg10_kle_in_usd[,3:32] <- tmvyll_df_wg10_kle_in_usd[,3:32]/82.572

write.csv(tmvyll_df_wg10_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r10_kle_in_INR.csv")
write.csv(tmvyll_df_wg10_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r10_kle_in_USD.csv")
