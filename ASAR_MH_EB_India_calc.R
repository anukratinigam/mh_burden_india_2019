...
write.csv(tmvyll_df_3, file = "~/ASAR/Mental_health_econ_burden_india/UA_r3_INR.csv")
write.csv(tmvyll_df_3_usd, file = "~/ASAR/Mental_health_econ_burden_india/UA_r3_USD.csv")
...
write.csv(tmvyll_df_5, file = "~/ASAR/Mental_health_econ_burden_india/UA_r5_INR.csv")
write.csv(tmvyll_df_5_usd, file = "~/ASAR/Mental_health_econ_burden_india/UA_r5_USD.csv")
...
write.csv(tmvyll_df_10, file = "~/ASAR/Mental_health_econ_burden_india/UA_r10_INR.csv")
write.csv(tmvyll_df_10_usd, file = "~/ASAR/Mental_health_econ_burden_india/UA_r10_USD.csv")
