#!/bin/R
# ASAR_MH_EB_India_calc_india_LE_Reanalysis2023.R
# By: Anukrati Nigam

################################################################################################
## Script to calculate MVYLL based on highest life expectancy in any Indian state in 2023 for ##
...
# Males
LE_Male_10_to_14$k_le_in <- 75.27 - 12
LE_Male_15_to_19$k_le_in<- 75.27 - 17
LE_Male_20_to_24$k_le_in <- 75.27 - 22
LE_Male_25_to_29$k_le_in <- 75.27 - 27
LE_Male_30_to_34$k_le_in <- 75.27 - 32
LE_Male_35_to_39$k_le_in <- 75.27 - 37
LE_Male_40_to_44$k_le_in <- 75.27 - 42
LE_Male_45_to_49$k_le_in <- 75.27 - 47
LE_Male_50_to_54$k_le_in <- 75.27 - 52
LE_Male_55_to_59$k_le_in <- 75.27 - 57
LE_Male_60_to_64$k_le_in <- 75.27 - 62
LE_Male_65_to_69$k_le_in <- 75.27 - 67
LE_Male_70_to_74$k_le_in <- 75.27 - 72
LE_Male_75_to_79$k_le_in <- 75.27 - 77
LE_Male_80_to_84$k_le_in <- 75.27 - 82
LE_Male_85_to_89$k_le_in <- 75.27 - 87
LE_Male_90_to_94$k_le_in <- 75.27 - 92
LE_Male_95_onwards$k_le_in <- 75.27 - 97


#Female LE
LE_Female_10_to_14$k_le_in <- 81.22 - 12
LE_Female_15_to_19$k_le_in <- 81.22 - 17
LE_Female_20_to_24$k_le_in <- 81.22 - 22
LE_Female_25_to_29$k_le_in <- 81.22 - 27
LE_Female_30_to_34$k_le_in <- 81.22 - 32
LE_Female_35_to_39$k_le_in <- 81.22 - 37
LE_Female_40_to_44$k_le_in <- 81.22 - 42
LE_Female_45_to_49$k_le_in <- 81.22 - 47
LE_Female_50_to_54$k_le_in <- 81.22 - 52
LE_Female_55_to_59$k_le_in <- 81.22 - 57
LE_Female_60_to_64$k_le_in <- 81.22 - 62
LE_Female_65_to_69$k_le_in <- 81.22 - 67
LE_Female_70_to_74$k_le_in <- 81.22 - 72
LE_Female_75_to_79$k_le_in <- 81.22 - 77
LE_Female_80_to_84$k_le_in <- 81.22 - 82
LE_Female_85_to_89$k_le_in <- 81.22 - 87
LE_Female_90_to_94$k_le_in <- 81.22 - 92
LE_Female_95_onwards$k_le_in <- 81.22 - 97
...
for( s in state_list){
  ...
  #K for males
  k_male_10_14_state = LE_Male_10_to_14$k_le_in[which(LE_Male_10_to_14$location_name == s)]
  k_male_15_19_state = LE_Male_15_to_19$k_le_in[which(LE_Male_15_to_19$location_name == s)]
  ...
  k_male_65_69_state = LE_Male_65_to_69$k_le_in[which(LE_Male_65_to_69$location_name == s)]
  k_male_70_74_state = LE_Male_70_to_74$k_le_in[which(LE_Male_70_to_74$location_name == s)]
  k_male_75_79_state = LE_Male_75_to_79$k_le_in[which(LE_Male_75_to_79$location_name == s)]
  k_male_80_84_state = LE_Male_80_to_84$k_le_in[which(LE_Male_80_to_84$location_name == s)]
  k_male_85_89_state = LE_Male_85_to_89$k_le_in[which(LE_Male_85_to_89$location_name == s)]
  k_male_90_94_state = LE_Male_90_to_94$k_le_in[which(LE_Male_90_to_94$location_name == s)]
  k_male_95_onwards_state = LE_Male_95_onwards$k_le_in[which(LE_Male_95_onwards$location_name == s)]
  
  #K for females
  k_female_10_14_state = LE_Female_10_to_14$k_le_in[which(LE_Female_10_to_14$location_name == s)]
  k_female_15_19_state = LE_Female_15_to_19$k_le_in[which(LE_Female_15_to_19$location_name == s)]
  ...
  k_female_65_69_state = LE_Female_65_to_69$k_le_in[which(LE_Female_65_to_69$location_name == s)]
  k_female_70_74_state = LE_Female_70_to_74$k_le_in[which(LE_Female_70_to_74$location_name == s)]
  k_female_75_79_state = LE_Female_75_to_79$k_le_in[which(LE_Female_75_to_79$location_name == s)]
  k_female_80_84_state = LE_Female_80_to_84$k_le_in[which(LE_Female_80_to_84$location_name == s)]
  k_female_85_89_state = LE_Female_85_to_89$k_le_in[which(LE_Female_85_to_89$location_name == s)]
  k_female_90_94_state = LE_Female_90_to_94$k_le_in[which(LE_Female_90_to_94$location_name == s)]
  k_female_95_onwards_state = LE_Female_95_onwards$k_le_in[which(LE_Female_95_onwards$location_name == s)]
...
tmvyll_df_3_kle_in_usd[,3:59] <- tmvyll_df_3_kle_in_usd[,3:59]/82.572

write.csv(tmvyll_df_3_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r3_kle_in_INR.csv")
write.csv(tmvyll_df_3_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r3_kle_in_USD.csv")
...
tmvyll_df_5_kle_in_usd[,3:59] <- tmvyll_df_5_kle_in_usd[,3:59]/82.572

write.csv(tmvyll_df_5_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r5_kle_in_INR.csv")
write.csv(tmvyll_df_5_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r5_kle_in_USD.csv")
...
tmvyll_df_10_kle_in_usd[,3:59] <- tmvyll_df_10_kle_in_usd[,3:59]/82.572

write.csv(tmvyll_df_10_kle_in, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r10_kle_in_INR.csv")
write.csv(tmvyll_df_10_kle_in_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r10_kle_in_USD.csv")
