#!/bin/R
# ASAR_MH_EB_India_calc_working_group_world_LE_Reanalysis2023.R
# By: Anukrati Nigam

#######################################################################################
## Script to calculate MVYLL based on highest life expectancy globally in 2023  for  ##
...
tmvyll_df_wg3_kle_usd[,3:32] <- tmvyll_df_wg3_kle_usd[,3:32]/82.572

write.csv(tmvyll_df_wg3_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r3_kle_INR.csv")
write.csv(tmvyll_df_wg3_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r3_kle_USD.csv")
...
tmvyll_df_wg5_kle_usd[,3:32] <- tmvyll_df_wg5_kle_usd[,3:32]/82.572

write.csv(tmvyll_df_wg5_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r5_kle_INR.csv")
write.csv(tmvyll_df_wg5_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r5_kle_USD.csv")
...
tmvyll_df_wg10_kle_usd[,3:32] <- tmvyll_df_wg10_kle_usd[,3:32]/82.572

write.csv(tmvyll_df_wg10_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r10_kle_INR.csv")
write.csv(tmvyll_df_wg10_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_wg_r10_kle_USD.csv")
