#!/bin/R
# ASAR_MH_EB_India_calc_world_LE_Reanalysis2023.R
# By: Anukrati Nigam

#######################################################################################
## Script to calculate MVYLL based on highest life expectancy globally in 2023       ##
...
# Males
LE_Male_10_to_14$k_le <- 83.157 - 12
LE_Male_15_to_19$k_le<- 83.157 - 17
LE_Male_20_to_24$k_le <- 83.157 - 22
LE_Male_25_to_29$k_le <- 83.157 - 27
LE_Male_30_to_34$k_le <- 83.157 - 32
LE_Male_35_to_39$k_le <- 83.157 - 37
LE_Male_40_to_44$k_le <- 83.157 - 42
LE_Male_45_to_49$k_le <- 83.157 - 47
LE_Male_50_to_54$k_le <- 83.157 - 52
LE_Male_55_to_59$k_le <- 83.157 - 57
LE_Male_60_to_64$k_le <- 83.157 - 62
LE_Male_65_to_69$k_le <- 83.157 - 67
LE_Male_70_to_74$k_le <- 83.157 - 72
LE_Male_75_to_79$k_le <- 83.157 - 77
LE_Male_80_to_84$k_le <- 83.157 - 82
LE_Male_85_to_89$k_le <- 83.157 - 87
LE_Male_90_to_94$k_le <- 83.157 - 92
LE_Male_95_onwards$k_le <- 83.157 - 97


#Female LE
LE_Female_10_to_14$k_le <- 87.54 - 12
LE_Female_15_to_19$k_le <- 87.54 - 17
LE_Female_20_to_24$k_le <- 87.54 - 22
LE_Female_25_to_29$k_le <- 87.54 - 27
LE_Female_30_to_34$k_le <- 87.54 - 32
LE_Female_35_to_39$k_le <- 87.54 - 37
LE_Female_40_to_44$k_le <- 87.54 - 42
LE_Female_45_to_49$k_le <- 87.54 - 47
LE_Female_50_to_54$k_le <- 87.54 - 52
LE_Female_55_to_59$k_le <- 87.54 - 57
LE_Female_60_to_64$k_le <- 87.54 - 62
LE_Female_65_to_69$k_le <- 87.54 - 67
LE_Female_70_to_74$k_le <- 87.54 - 72
LE_Female_75_to_79$k_le <- 87.54 - 77
LE_Female_80_to_84$k_le <- 87.54 - 82
LE_Female_85_to_89$k_le <- 87.54 - 87
LE_Female_90_to_94$k_le <- 87.54 - 92
LE_Female_95_onwards$k_le <- 87.54 - 97
...
tmvyll_df_3_kle_usd[,3:59] <- tmvyll_df_3_kle_usd[,3:59]/82.572

write.csv(tmvyll_df_3_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r3_kle_INR.csv")
write.csv(tmvyll_df_3_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r3_kle_USD.csv")
...
tmvyll_df_5_kle_usd[,3:59] <- tmvyll_df_5_kle_usd[,3:59]/82.572

write.csv(tmvyll_df_5_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r5_kle_INR.csv")
write.csv(tmvyll_df_5_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r5_kle_USD.csv")
...
tmvyll_df_10_kle_usd[,3:59] <- tmvyll_df_10_kle_usd[,3:59]/82.572

write.csv(tmvyll_df_10_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r10_kle_INR.csv")
write.csv(tmvyll_df_10_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2023/Datasets/UA_r10_kle_USD.csv")
