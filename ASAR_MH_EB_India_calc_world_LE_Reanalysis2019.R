#!/bin/R
# ASAR_MH_EB_India_calc_world_LE_Reanalysis2019.R
# By: Anukrati Nigam
...
# Males
LE_Male_10_to_14$k_le <- 84.61 - 12
LE_Male_15_to_19$k_le<- 84.61 - 17
...
LE_Male_65_to_69$k_le <- 84.61 - 67
LE_Male_70_to_74$k_le <- 84.61 - 72
LE_Male_75_to_79$k_le <- 84.61 - 77
LE_Male_80_to_84$k_le <- 84.61 - 82
LE_Male_85_to_89$k_le <- 84.61 - 87
LE_Male_90_to_94$k_le <- 84.61 - 92
LE_Male_95_onwards$k_le <- 84.61 - 97


#Female LE
LE_Female_10_to_14$k_le <- 87.92 - 12
LE_Female_15_to_19$k_le <- 87.92 - 17
...
LE_Female_65_to_69$k_le <- 87.92 - 67
LE_Female_70_to_74$k_le <- 87.92 - 72
LE_Female_75_to_79$k_le <- 87.92 - 77
LE_Female_80_to_84$k_le <- 87.92 - 82
LE_Female_85_to_89$k_le <- 87.92 - 87
LE_Female_90_to_94$k_le <- 87.92 - 92
LE_Female_95_onwards$k_le <- 87.92 - 97
...
write.csv(tmvyll_df_3_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2019/Datasets/UA_r3_kle_INR.csv")
write.csv(tmvyll_df_3_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2019/Datasets/UA_r3_kle_USD.csv")
...
write.csv(tmvyll_df_5_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2019/Datasets/UA_r5_kle_INR.csv")
write.csv(tmvyll_df_5_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2019/Datasets/UA_r5_kle_USD.csv")
...
write.csv(tmvyll_df_10_kle, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2019/Datasets/UA_r10_kle_INR.csv")
write.csv(tmvyll_df_10_kle_usd, file = "~/ASAR/Mental_health_econ_burden_india/Reanalysis/Reanalysis17102025/AnalysisYear2019/Datasets/UA_r10_kle_USD.csv")
